...
import prabhakar.core.services.ComponentsInfoService;
import prabhakar.core.utils.ResolverUtil;

@Component(immediate = true, service = ComponentsInfoService.class, name = "prabhakar.core.services.ComponentsInfo", configurationPid = "com.aem.geeks.core.services.impl.ComponentsInfoImpl",
		property = {
