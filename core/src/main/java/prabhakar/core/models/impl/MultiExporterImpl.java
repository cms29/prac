...
import prabhakar.core.models.MultiExporter;
import prabhakar.core.models.XmlExporter;
...
@Exporters({
        @Exporter(name = "jackson",extensions = "json",selector = "Newjson",
        options = {
                @ExporterOption(name = "SerializationFeature.WRAP_ROOT_VALUE", value="true")
        }),
        @Exporter(name = "Newxml",extensions = "xml",selector = "Newxml")
})
@Model(
...
public class MultiExporterImpl implements MultiExporter {
    static final String RESOURCE_TYPE="prabhakar/components/content/multiexporter";
