...
import java.util.*;
@Exporter(name = "Newxml",extensions = "xml",selector = "New")
@Model(
...
@XmlRootElement(name = "New-exporter")
public class XmlExporterImpl implements XmlExporter {
    static final String RESOURCE_TYPE="prabhakar/components/content/xmlexporter";
