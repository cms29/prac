package prabhakar.core.workflows;
...
@Component(
        ...
        property = {
                "process.label" + " =  Workflow Step",
                Constants.SERVICE_VENDOR + "=AEM ",
                Constants.SERVICE_DESCRIPTION + " = Custom  workflow step."
        }
)
public class NewWorkflowStep implements WorkflowProcess {
    private static final Logger LOG = LoggerFactory.getLogger(NewWorkflowStep.class);
